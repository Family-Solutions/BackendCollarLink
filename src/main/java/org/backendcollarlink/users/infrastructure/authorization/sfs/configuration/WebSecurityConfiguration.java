package org.backendcollarlink.users.infrastructure.authorization.sfs.configuration;

import org.backendcollarlink.users.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import org.backendcollarlink.users.infrastructure.hashing.bcypt.BCryptHashingService;
import org.backendcollarlink.users.infrastructure.tokens.jwt.BearerTokenService;
        ...
        http.csrf(csrfConfigurer -> csrfConfigurer.disable())
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers(
                                ...
                                "/swagger-ui/**",
                                "/swagger-resources/**",
                                "/api/v1/collar/updateLocation/**",
                                "/api/v1/collar/serialNumber/**",
                                "/webjars/**").permitAll()
